  ...
  try{
    ...
    window.patchBundle = function(src){
      ...
      try {
        ...
        if (wmi !== -1) {
          var wmCode = "try{if(document.activeElement&&(document.activeElement.tagName==='INPUT'||document.activeElement.tagName==='TEXTAREA'))return;if(a3o.type==='keydown'){if(a3o.repeat)return;if(a3o.keyCode===81||a3o.code==='KeyQ'||a3o.key==='q'||a3o.key==='Q'){if(window.__dsGlooQuickDeploy)window.__dsGlooQuickDeploy();}else if(a3o.keyCode===66||a3o.code==='KeyB'||a3o.key==='b'||a3o.key==='B'){if(window.__dsGlooToggle)window.__dsGlooToggle();}}}catch(e){}";
