...
Java_com_deadshot_offline_NodeRunner_startNodeWithArguments(
        JNIEnv *env,
        jobject /* thisObj */,
    ...
    // Compute total byte size for contiguous memory buffer required by libUV
    ...
    __android_log_write(ANDROID_LOG_INFO, ADBTAG, "Starting embedded Node.js runtime...");
